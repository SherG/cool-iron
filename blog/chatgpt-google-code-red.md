...
### . . . ChatGPT can already deliver results inside Google 

This <a href="https://chrome.google.com/webstore/detail/chatgpt-for-google/jgjaeacdkonaoafenlfkkkmbaopkbilf" target="blank">ChatGPT for Google</a> Chrome extension causes ChatGPT's answers to your queries to _appear directly in Google search results_, in the right-hand margin. 
...
ChatGPT struggles to understand and satisfy _**search intent**_, a fulcrum responsible for moving billions of dollars in commerce. This Google search for "<strong>lambskin bomber jackets</strong>" yields results with images, prices, and customer ratings.
