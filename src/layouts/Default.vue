      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/" @click.native="scrollToTop">
            <g-image src="../../static/signalfox.svg" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/" @click.native="scrollToTop">
            <g-image src="../../static/signalfox-darmode.svg" class="w-40" alt="logo" />
          </g-link>
        </div>
        ...
        >
          ...
          <li>
            ...
            <g-link v-else to="/#contact" class="text-copy-primary hover:text-gray-600">Connect</g-link>
          </li>
          <li>
